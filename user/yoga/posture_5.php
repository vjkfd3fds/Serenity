            ...
            <tr>
                <th>
                    <table class="yoga_options_detail">
                        <tr>
                            <td style="text-align: left;"><p class="yoga_title">Fish pose (Matsyasana)</p></td></a>
                        </tr>
                        <tr>
                            <th width="100%"><img style="border-radius: 20%;" src="../images/yoga_img_5.1.png" alt=""></th>
                        </tr>
                        <tr>
                            <td style="text-align: left; font-weight: 500;">
                                <div class="yoga_dis">
                                    ...
                                    <p>
                                        <ol>
                                            <li>Lie flat on your back with your legs straight and arms resting by your sides.</li>
                                            <li>Bend your knees and place your feet flat on the floor, bringing them as close to your buttocks as possible.</li>
                                            <li>Lift your hips slightly off the ground and slide your hands palms-down underneath your buttocks.</li>
                                            <li>Press your forearms and elbows firmly into the ground, and inhale as you lift your chest towards the ceiling.</li>
                                            <li>Tilt your head back and rest the crown of your head on the ground, or lift your head off the ground and gently arch your neck. </li>
                                            <li>Hold the pose for 5-10 deep breaths, then slowly release by lowering your chest and head back to the ground.</li>
                                        </ol>
                                    </p>
                                </div>
                            </td>
                        ...
                        <tr>
                          <th>
                            <div class="msg">
                                ...
                                <p id="msg">Times Up.. <a style="color: green;" href="posture_5.php">Restart</a></p>
                            </div>
                          </th>
                        </tr>
                    </table>
