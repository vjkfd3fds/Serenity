            ...
            <tr>
                <th>
                    <table class="yoga_options_detail">
                        <tr>
                            <td style="text-align: left;"><p class="yoga_title">Downward Facing Dog (Adho Mukha Svanasana)</p></td></a>
                        </tr>
                        <tr>
                            <th width="100%"><img style="border-radius: 50px;" src="../images/yoga_img_3.1.png" alt=""></th>
                        </tr>
                        <tr>
                            <td style="text-align: left; font-weight: 500;">
                                <div class="yoga_dis">
                                    ...
                                    <p>
                                        <ol>
                                            <li>Begin on your hands and knees, with wrists directly under shoulders and your knees directly under your hips.</li>
                                            <li>Spread your fingers wide and press your palms into the mat. Engage your core and tuck your toes under.</li>
                                            <li>On an exhale, lift your knees off the mat and straighten your legs, coming into an inverted V-shape.</li>
                                            <li>Your hands should be shoulder-width apart and your feet hip-width apart. Press your heels towards the ground, but don't worry if they don't touch.</li>
                                            <li>Lengthen your spine and draw your shoulder blades down and away from your ears. Your head should be relaxed and your gaze directed towards your feet.</li>
                                            <li>Hold the pose for 5-10 breaths, then release by dropping your knees back down to the mat.</li>
                                        </ol>
                                    </p>
                                </div>
                            </td>
                        ...
                        <tr>
                          <th>
                            <div class="msg">
                                ...
                                <p id="msg">Times Up.. <a style="color: green;" href="posture_3.html">Restart</a></p>
                            </div>
                          </th>
                        </tr>
                    </table>
