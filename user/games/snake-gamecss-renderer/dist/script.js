...
(function(){ 'use strict';
  ...
  StatePlay.prototype.step = function() {
    if (!this.gameOver) {  
      if (this.snake.deathFlag) {
        this.gameOver = true;
        this.finalScore = this.score;
  
        // Display a prompt to enter the earned score
        var earnedScore = prompt("Game Over! You earned " + this.finalScore + " points. Enter your name to save your score:");
        
        // Check if the user entered a name and did not click Cancel
        if (earnedScore !== null && earnedScore !== "") {
          // Create a new webpage to display the earned score
          var newPage = window.open("", "_blank");
          newPage.document.write("<h1>Game Over</h1>");
          newPage.document.write("<p>Congratulations, " + earnedScore + "!</p>");
          newPage.document.write("<p>Your earned score: " + this.finalScore + "</p>");
        }
      }
...
(function(){ 'use strict';
  ...
  function gameOver() {
    // Stop the game (pause the game loop)
    ...
    // For example, you can reset player's score, position, etc.
  
    // Restart the game if needed
    // You can add logic here to ask the player if they want to play again and restart the game accordingly
