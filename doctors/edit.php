<?php 
	...
	if (isset($_POST['manage'])) {
		...
		$sql = "UPDATE doctor_details SET fullname = ?, workemail = ?, dob = ?, workingdate = ?, address = ?,  experience = ?, education = ?,
				phonenumber = ?, description = ?, age = ? WHERE did = ?";

		$stmt = $conn->prepare($sql);
		$stmt->bind_param("sssssssssss", $fullname, $email, $dob, $workingdate, $address, $experience, $education, $phonenumber, $about, $age, $did);
		        ...
		        <div class="app-header-content"> 
		            ...
		            <div class="app-utilities col-auto">
			            ...
			            <div class="app-utility-item app-user-dropdown dropdown">
				            <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"><img class="profile-image" src="profile/<?php echo $row['profile'];?>" alt=""></a>
